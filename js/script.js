...
var hide = document.querySelectorAll('.player');
var columnLeft = document.querySelectorAll('.left');
var columnRight = document.querySelectorAll('.right');
var scoreLeft = document.querySelectorAll('.scoreLeft');
var scoreRight = document.querySelectorAll('.scoreRight');
var windowScore = document.querySelector('#windowScore');
var big = document.querySelector('.big_game_title');
var score;
var sumScore = 0;

big.addEventListener("click", () => {
   for (i = 0; i < columnLeft.length; i++) {
      columnLeft[i].classList.toggle('alcoclass');
   }
});

hide[0].addEventListener("click", () => {
   for (i = 0; i < columnLeft.length; i++) {
      score = +scoreLeft[i].value;
      sumScore += score;
      windowScore.innerHTML = sumScore;
   }
});
hide[1].addEventListener("click", () => {
   for (i = 0; i < columnRight.length; i++) {
      score = +scoreRight[i].value;
      sumScore += score;
      windowScore.innerHTML = sumScore;
   }
});
...
var turnOn = document.querySelector('#but');
var turnOff = document.querySelector('.main');
